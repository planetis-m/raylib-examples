...
proc main =
  ...
  var fudesumiRaw = loadImageRaw("resources/fudesumi.raw", 384, 512, PixelformatUncompressedR8g8b8a8, 0)
  var fudesumi = loadTextureFromImage(fudesumiRaw) # Upload CPU (RAM) image to GPU (VRAM)
